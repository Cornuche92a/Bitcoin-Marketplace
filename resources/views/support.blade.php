                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content table-responsive">
                        <table class="table table-striped table-vcenter table-responsive">
                            ...
                            <tbody>
                            @if($tickets->where('state_id','=','1')->isEmpty())
                                <tr>
                                ...
                                @foreach($tickets as $ticket)
                                    @if($ticket->state_id == 1)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <form action="{{action('Support@show')}}" method="POST">
                                                        {{csrf_field()}}
                        ...
                        <div class="block-content">
                            <table class="table table-borderless table-responsive">
                                ...
                                @endforeach
                                    ...
                                    @if($conversations[0]->ticket->state_id == 1)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{action('Support@reply')}}" method="POST" >
                                                {{csrf_field()}}
                                                <div class="mb-4">
                                                    ...
                                                    <input type="hidden" name="ticket_id" value="{{$concern}}">
                                                </div>
